...
Type| ICMPEchoRequest | ICMPEchoReply | ICMPDestinationUnreachable | ICMPSourceQuench | ICMPRedirect | ICMPTimeExceeded | ICMPParameterProblem | ICMPTimestampReply | ICMPInfoReply | ICMPAddressMaskReply 
--- | --- | --- | --- |--- |--- |--- |--- |--- |--- |--- 
